    ...
    <main>
        ...
        <div class="w-75 mx-auto">
            ...
            <div class="card border-dark w-50 mx-auto">
                <div class="card-header bg-dark font-weight-bolder">
                    <span class="text-white float-left">{{$item->username}}</span>
                </div>
                <div class="card-body text-center">
                    <img src="{{url('public/storage/images/users_image.jpg')}}" style="width: 230px; object-fit: cover; height: 240px;" class="img-thumbnail float-left">
                    <div>
                        <span class="font-weight-bolder">ID: </span> <span>{{$item->id}}</span>
                    </div>
                    <div>
                        <span class="font-weight-bolder">Telefone: </span> <span>{{$item->telephone}}</span>
                    </div>
                    <div>
                        <span class="font-weight-bolder">Estado: </span><span>{{$item->state}}</span>
                    </div>
                </div>
            </div>
            @endforeach
