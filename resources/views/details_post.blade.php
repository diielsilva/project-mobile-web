        ...
        <div class="card w-50 mx-auto border-dark mb-3">
            ...
            <div class="card-body">
                ...
                <p class="text-center font-weight-bolder">
                    Postado Por: <span class="font-weight-normal">{{$item->postedby}}</span>
                </p>
                <p class="text-center font-weight-bolder">
                ...
                <p class="text-center font-weight-bolder"> Telefone do usuário: <span
                        class="font-weight-normal">{{$item->telephone}}</span> </p>
            </div>
        </div>
        @endforeach
    </main>
