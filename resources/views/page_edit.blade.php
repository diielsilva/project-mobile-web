...
<body class="text-center">
    ...
    <main>
        ...
        <div class="w-50 mx-auto">
            <form action="http://localhost/petfinder/update/post/{{$id}}" method="post" class="form-group  w-50 mx-auto">
                ...
                <div class="card  border-dark mx-auto mt-2">
                    <div class="card-header bg-dark text-white font-weight-bolder">
                        Descrição &nbsp;<span class="fas fa-file-alt"></span>
                    </div>
                    <div class="">
                        <textarea name="description" maxlength="350" id="" cols="30" rows="10"
